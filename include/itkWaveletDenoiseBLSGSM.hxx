 ...
 *
 *=========================================================================*/
#ifndef itkWaveletDenoiseBLSGSM_hxx
#define itkWaveletDenoiseBLSGSM_hxx
...
namespace itk
{
template< typename TImage, typename TImage>
WaveletDenoiseBLSGSM< TImage, TImage >
...
template< typename TImage, typename TImage>
std::vector< typename WaveletDenoiseBLSGSM< TImage, TImage >
  ::OutputImagePointer >
WaveletDenoiseBLSGSM< TImage, TImage >
...
::GenerateOutputRequestedRegion(DataObject *refOutput)
{
  ...
  TImage *ptr = itkDynamicCastInDebugMode< TImage * >(refOutput);
  if ( !ptr )
    {
    itkExceptionMacro(<< "Could not cast refOutput to TImage*.");
    }
