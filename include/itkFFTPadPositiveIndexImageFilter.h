 ...
 * \brief Pad an image to make it suitable for an FFT transformation. The difference with @sa FFTPadImageFilter is that the padded image has no negative indices, that can be problematic for @NeighborIterator.
 *
